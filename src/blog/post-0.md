...
<div class="w-full flex justify-center p-0">
  <mux-player
    playback-id="O02mFrvtTMm3uosawsUmC8kNzy6EYOh015M7K00kuJHaZg"
    class="
      w-full
      max-w-xs
      sm:max-w-sm
      ...
      aspect-video
    "
    metadata-video-title="hand_water_pump"
    playsinline
  ></mux-player>
</div>
<p class="xl:w-250 sm:leading-relaxed opacity-70 text-xs text-center mt-5">
...
<div class="w-full flex justify-center p-0">
  <mux-player
    playback-id="2pe202Z56utqAzX3kWom12wYbAJ1bi02kKtR4gu4CBp00M"
    class="
      w-full
      max-w-xs
      sm:max-w-sm
      ...
      aspect-video
    "
    metadata-video-title="stone_skimming"
    playsinline
  ></mux-player>
</div>
...
<div class="w-full flex justify-center p-0">
  <mux-player
    playback-id="mjGt01A29xbbbHnCG015GqlXAAqTbMhgExMVSSXAflU00o"
    class="
      w-full
      max-w-xs
      sm:max-w-sm
      ...
      aspect-video
    "
    metadata-video-title="sunday_morning_moment"
    playsinline
  ></mux-player>
</div>
...
<div class="w-full flex justify-center p-0">
  <mux-player
    playback-id="IVwR37j01mKAs9bzKkEiSqYbTJY6bJnBLJxK6018UWxmE"
    class="
      w-full
      max-w-xs
      sm:max-w-sm
      ...
      aspect-video
    "
    metadata-video-title="on_the_way_statue_of_unity"
    playsinline
  ></mux-player>
</div>
